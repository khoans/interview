...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees whose salary is between 3000 and 7000 (inclusive).
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees who do not have a department_id assigned (NULL).
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees whose name contains the letter 'o'.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to return distinct department_ids from the employees table.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees ordered by salary in descending order.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees whose department_id is either 1, 3, or 5.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find all employees whose name ends with 'son'.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find the total sum of all salaries.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to count how many employees have NULL department_id.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find the total salary budget per department, ordered by total budget descending.
...
TABLE employee_projects
    ...
    PRIMARY KEY (employee_id, project_id)
```
Write a query to count how many projects each employee is working on.
...
TABLE employees
    ...
    department_id INTEGER REFERENCES departments(id)
```
Write a query to find departments that have employees with salary above 10000.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to update all employees' salary by 10% for those in department_id = 1.

---

**42.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
    ...
    department_id INTEGER
```
Write a query to delete all employees who do not have a department_id assigned.
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to insert a new employee with name 'Jane Doe', salary 6000, department_id 3.

---

**44.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
    ...
    department_id INTEGER
```
Write a query to find duplicate names in the employees table (names that appear more than once).

---

**45.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
    ...
    department_id INTEGER
```
Write a query to find employees whose salary is NULL.

---

**46.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
    ...
    department_id INTEGER
```
Write a query using CASE statement to categorize employees as 'Low' (salary < 4000), 'Medium' (4000-8000), 'High' (> 8000).

---

**47.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
    salary DECIMAL(10, 2)
```
Write a query to find the 3rd highest salary without using LIMIT/OFFSET.

---

**48.** Given the following table:
```sql
TABLE employees
    id INTEGER NOT NULL PRIMARY KEY
    name VARCHAR(255) NOT NULL
...
TABLE employees
    ...
    department_id INTEGER
```
Write a query to find consecutive employees (by id) who work in the same department.
...
TABLE employees
    ...
    name VARCHAR(255) NOT NULL
    salary DECIMAL(10, 2)
    department_id INTEGER  -- Values: 'IT', 'HR', 'Sales'
```
Write a query to pivot the data: show each department as a column with the count of employees.

---

## Answer Template

Create your answers in separate files under `sicpa/practice/sql/` following this format:
